            ...
            <section class="reservation">
                <div class="container">
                    ...
                    <div class="reservation-form wow fadeInUp">
                        <form  action="{{route('tableau-reservation.store')}}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label for="name">Nom</label>
                                        <input type="text" class="form-control" id="name" name="nom_client" placeholder="Full Name" title="Your Full Name please" required>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="" name="genre_reservation" placeholder="le genre de perssones de cette événement" title=" entrer le genre de perssones de cette événement" required>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="phone" name="telephone_reservation" placeholder="Enter your Phone Number" title="Please enter your phone number" required>
